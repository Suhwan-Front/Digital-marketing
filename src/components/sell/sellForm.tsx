...
const SellForm: React.FC = () => {
  ...
  return (
    <form className="space-y-6">
      ...
      <div>
        <label htmlFor="productName" className="text-gray-600 font-medium block mb-1">제품 이름</label>
        <input
          type="text"
          id="productName"
      ...
      <div>
        <label htmlFor="productCategory" className="text-gray-600 font-medium block mb-1">제품 카테고리</label>
        <input
          type="text"
          id="productCategory"
          className="w-full py-2 px-4 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-400"
      ...
      <div>
        <label htmlFor="productQuantity" className="text-gray-600 font-medium block mb-1">제품 수량</label>
        <input
          type="number"
          id="productQuantity"
          className="w-full py-2 px-4 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-400"
      ...
      <div>
        <label htmlFor="deliveryFee" className="text-gray-600 font-medium block mb-1">배달비</label>
        <input
          type="text"
          id="deliveryFee"
          className="w-full py-2 px-4 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-400"
      ...
      <div>
        <label htmlFor="productDescription" className="text-gray-600 font-medium block mb-1">제품 설명</label>
        <textarea
          id="productDescription"
          className="w-full h-32 py-2 px-4 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-400"
      ...
      <div>
        <label htmlFor="productImage" className="text-gray-600 font-medium block mb-1">제품 이미지 URL</label>
        <input
          type="text"
          id="productImage"
          className="w-full py-2 px-4 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-400"
